...
import { INotificacion } from 'app/shared/model/notificacionmicroservicio/notificacion.model';
...
export class NotificacionService {
  public resourceUrl = SERVER_API_URL + 'services/notificacionmicroservicio/api/notificacions';
  ...
  protected convertDateFromClient(notificacion: INotificacion): INotificacion {
    const copy: INotificacion = Object.assign({}, notificacion, {
      ...
      fechaSeed: notificacion.fechaSeed && notificacion.fechaSeed.isValid() ? notificacion.fechaSeed.toJSON() : undefined
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.fechaSeed = res.body.fechaSeed ? moment(res.body.fechaSeed) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((notificacion: INotificacion) => {
        ...
        notificacion.fechaSeed = notificacion.fechaSeed ? moment(notificacion.fechaSeed) : undefined;
      });
    }
    return res;
  }
