...
describe('Notificacion e2e test', () => {
  ...
  it('should load Notificacions', async () => {
    ...
    expect(await notificacionComponentsPage.getTitle()).to.eq('gatewaystoreApp.notificacionmicroservicioNotificacion.home.title');
    await browser.wait(
  ...
  it('should load create Notificacion page', async () => {
    ...
    expect(await notificacionUpdatePage.getPageTitle()).to.eq(
      'gatewaystoreApp.notificacionmicroservicioNotificacion.home.createOrEditLabel'
    );
  ...
  it('should create and save Notificacions', async () => {
    ...
    await promise.all([
      ...
      notificacionUpdatePage.setFechaSeedInput('01/01/2001' + protractor.Key.TAB + '02:30AM'),
    ...
    expect(await notificacionUpdatePage.getFechaSeedInput()).to.contain(
      '2001-01-01T02:30',
      'Expected fechaSeed value to be equals to 2000-12-31'
    );
  ...
  it('should delete last Notificacion', async () => {
    ...
    expect(await notificacionDeleteDialog.getDialogTitle()).to.eq('gatewaystoreApp.notificacionmicroservicioNotificacion.delete.question');
